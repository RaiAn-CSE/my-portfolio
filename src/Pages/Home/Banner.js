    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row lg:flex basis-2/4 my-8 mx-8'>
            <div className='w-full lg:w-1/2 flex flex-col justify-center'>
                ...
                <div>
                    <a href='https://drive.google.com/file/d/1e0lS7yLylI5o2mro_sG0j5rqIVCDu177/view?usp=sharing' target="_blank" rel="noopener noreferrer"><button type="button" class="text-white bg-orange-400 hover:bg-orange-500 focus:outline-none focus:ring-4 focus:ring-orange-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-orange-900">Resume</button></a>
                </div>
            </div>
            <div className=" w-full lg:w-1/2">
                <img className='w-full h-full rounded-full' src={img1} alt="banner" />
            </div>
        </div>
    );
};
